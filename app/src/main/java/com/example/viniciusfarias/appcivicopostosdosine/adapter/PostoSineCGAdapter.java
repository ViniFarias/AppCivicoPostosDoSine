...
public class PostoSineCGAdapter extends RecyclerView.Adapter<PostoSineCGAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        int itemPosition = sineCGActivity.getRcPostosSine().getChildLayoutPosition(v);
        String codPosto = mDataset.get(itemPosition).getCodPosto();
        ...
        this.sineCGActivity.startActivity(intent);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public String getCodPosto(){
            return tvCodPosto.getText().toString();
        }
    }
    ...
    public PostoSineCGAdapter(ArrayList<PostoSine> myDataset, SineCGActivity sineCGActivity) {
        mDataset = myDataset;
